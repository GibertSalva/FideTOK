...
export const INITIALIZE_EXTRA_ACCOUNT_META_LIST_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([92, 197, 174, 197, 41, 124, 19, 3]);

export function getInitializeExtraAccountMetaListDiscriminatorBytes(): ReadonlyUint8Array {
